...
def handledata():
    ...
    copy_directory("./data/cover/" + c.class_name + "/train/good", "./dataset/" + c.class_name + "/train/good")
    copy_directory("./data/cover/" + c.class_name + "/test/good", "./dataset/" + c.class_name + "/test/good")
    ...
    # HAZELNUT
    # copy_directory(
    #     "./data/cover/" + c.class_name + "/test/crack", "./dataset/" + c.class_name + "/test/anomaly", "crack"
    # )
    # copy_directory("./data/cover/" + c.class_name + "/test/cut", "./dataset/" + c.class_name + "/test/anomaly", "cut")
    # copy_directory("./data/cover/" + c.class_name + "/test/hole", "./dataset/" + c.class_name + "/test/anomaly", "hole")
    # copy_directory(
    #     "./data/cover/" + c.class_name + "/test/print", "./dataset/" + c.class_name + "/test/anomaly", "print"
    # )
    copy_directory("./data/cover/" + c.class_name + "/test/ng", "./dataset/" + c.class_name + "/test/anomaly", "ng")
    # copy_directory("./data/cover/" + c.class_name + "/test/cut", "./dataset/" + c.class_name + "/test/anomaly", "cut")
    # copy_directory("./data/cover/" + c.class_name + "/test/hole", "./dataset/" + c.class_name + "/test/anomaly", "hole")
    # copy_directory(
    #     "./data/cover/" + c.class_name + "/test/print", "./dataset/" + c.class_name + "/test/anomaly", "print"
